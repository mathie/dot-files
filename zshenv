...
export PATH="${HOME}/bin:${HOME}/.rbenv/bin:${HOME}/.rbenv/shims:${PERL_LOCAL_LIB_ROOT}/bin:/usr/local/bin:/usr/local/sbin:/usr/local/share/npm/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin"
