...
DOT_FILES = MacOSX gemrc git_template gitconfig gitignore_global tmux.conf zshrc zsh_functions editrc pryrc tmuxinator ackrc my.cnf bashrc bash_profile sleepwatcher
